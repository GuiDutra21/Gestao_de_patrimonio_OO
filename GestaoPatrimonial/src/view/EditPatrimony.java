...
import view.PatrimonyScreean.Tipo;
...
public class EditPatrimony implements ActionListener
{
	...
	public EditPatrimony(String patrimonyName,PatrimonyScreean.Tipo tipo, ControlerCompany c, String filialName) {
		...
		labels.add( new JLabel("Edite os dados do Patrimônio:"));
		...
		textFields.add(new JTextField(this.patrimonyName));
		...
		textFields.add(new JTextField(String.format("%f",c.getPatrimony(filialName, patrimonyName).getValue())));
		...
		textFields.add(new JTextField(String.format("%d",c.getPatrimony(filialName, patrimonyName).getAmount())));
		...
		if(tipo == Tipo.VEHICLE) {
			...
			textFields.add(new JTextField(c.getVehicle(filialName, patrimonyName).getBrand()));
			...
			textFields.add(new JTextField(c.getVehicle(filialName, patrimonyName).getModel()));
			...
			textFields.add(new JTextField(String.format("%d",c.getBuildings(filialName, patrimonyName).getFloorsQtd())));
			textFields.get(3).setBounds(615,300,350,30);
			...
			textFields.add(new JTextField(String.format("%f",c.getBuildings(filialName, patrimonyName).getArea())));
			textFields.get(4).setBounds(615, 360, 350, 30);
			...
			textFields.add(new JTextField(c.getBuildings(filialName, patrimonyName).getAddress().getCountry()));
			...
			textFields.add(new JTextField(c.getBuildings(filialName, patrimonyName).getAddress().getState()));
			...
			textFields.add(new JTextField(c.getBuildings(filialName, patrimonyName).getAddress().getCity()));
